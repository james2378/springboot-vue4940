...
const routes = [
	...
	// 美食达人路由
	{
		path: '/gourmet_master/table',
		name: 'gourmet_master_table',
		component: () => import('../views/gourmet_master/table.vue')
	},
	{
		path: '/gourmet_master/view',
		name: 'gourmet_master_view',
		component: () => import('../views/gourmet_master/view.vue')
	},
	// 美食好店路由
	{
		path: '/good_food_shop/table',
		name: 'good_food_shop_table',
		component: () => import('../views/good_food_shop/table.vue')
	},
	{
		path: '/good_food_shop/view',
		name: 'good_food_shop_view',
		component: () => import('../views/good_food_shop/view.vue')
	},
	// 美食信息路由
	{
	...
	// 美食提问路由
	{
		path: '/food_questions/table',
		name: 'food_questions_table',
		component: () => import('../views/food_questions/table.vue')
	},
	{
		path: '/food_questions/view',
		name: 'food_questions_view',
		component: () => import('../views/food_questions/view.vue')
	},
