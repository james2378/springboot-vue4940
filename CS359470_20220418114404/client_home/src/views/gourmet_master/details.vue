<template>
	<div class="diy_details page_gourmet_master" id="gourmet_master_details">
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_gourmet_master'>
							<div_gourmet_master :obj="obj"></div_gourmet_master>
						</div>
					</div>
				</div>
			</div>
...
<script>
	import div_gourmet_master from "@/components/diy/div_gourmet_master.vue";
	...
	export default {
		...
		methods:{
			...
			add_hits(obj) {
				obj["hits"] = obj["hits"] + 1;
				var hits = obj["hits"];
				this.$post('~/api/gourmet_master/set?gourmet_master_id=' + obj["gourmet_master_id"], {
					hits
				}, (res) => {
					if(res.result){
			...
			get_collect(obj) {
				...
				var query = {
					source_table: "gourmet_master",
					source_field: "gourmet_master_id",
					source_id: obj["gourmet_master_id"],
					user_id
				};
